...
public class TestLibrary {
	...
	public static void main(String args[]){
		...
		do {
			...
			System.out.println("2. Search for book (by book title)");
			...
			if (temp == 2){
				tempBook = sc1.nextLine();
				the_guy.findMeBook(tempBook);
			}
			if (temp == 3){
				tempAuthor = sc1.nextLine();
				the_guy.findMeBooksFromAuthor(tempAuthor);
			}
			if (temp == 4){
				break;
			}	
